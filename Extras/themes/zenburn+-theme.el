...
;;; Code:
(deftheme zenburn+ "The Zenburn color theme with additional mode-specific colors")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(cursor ((t (:foreground ,zenburn-orange :background ,zenburn-orange))))
   ...
   `(mode-line
     ((,class (:foreground ,zenburn-green-1
                           ...
                           :box (:line-width -1 :style released-button)))
      (t :inverse-video t)))
   ;`(mode-line-buffer-id ((t (:foreground ,zenburn-green+0 :weight bold))))
   `(mode-line-buffer-id ((t (:weight bold))))
   `(mode-line-inactive
     ((t (:foreground ,zenburn-green-1
                      :background ,zenburn-bg-05
                      :box (:line-width -1 :style released-button)))))
   `(region ((,class (:background ,zenburn-yellow)
                     (:foreground "black"))
             (t :inverse-video t)))
   ...
   ;; auctex
   `(font-latex-bold-face ((t (:foreground ,zenburn-yellow :inherit bold))))    ;,zenburn-green+1 also OK
   `(font-latex-italic-face ((t (:foreground ,zenburn-yellow :inherit italic))))
   `(font-latex-warning-face ((t (:foreground "red" :inherit font-lock-warning-face))))
   `(font-latex-sedate-face ((t (:foreground "gray75" :weight bold ))))   ; formerly LightGray
   `(font-latex-keyword-face ((t (:foreground "gray60" :inherit font-lock-keyword-face))))  ; formerly ,zenburn-yellow but too obtrusive
   `(font-latex-title-4 ((t (:foreground ,zenburn-magenta :inherit variable-pitch :weight bold))))
   `(font-latex-sectioning-5-face ((t (:foreground ,zenburn-magenta :inherit variable-pitch :weight bold))))
   ...
   ;; workgroups
   `(wg-current-workgroup-face  ((((class color)) (:foreground "white"))))
   `(wg-previous-workgroup-face ((((class color)) (:foreground ,zenburn-green+0))))
   `(wg-brace-face              ((((class color)) (:foreground "gray50"))))
   `(wg-divider-face            ((((class color)) (:foreground "gray50"))))
   `(wg-command-face            ((t (:foreground ,zenburn-yellow))))

   ;; icicles
   `(icicle-current-candidate-highlight ((t (:background "#cd5c5c")))))
  ...
  (custom-theme-set-variables
   ...
   `(fci-rule-color "#999999")

   ;; win-switch
   `(win-switch-feedback-background-color ,zenburn-cyan)
   `(win-switch-feedback-foreground-color ,zenburn-green-1))

  (set-cursor-color zenburn-orange)
  (message "CRG-Modified Zenburn Loaded"))
